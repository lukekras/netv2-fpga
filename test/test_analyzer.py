...
analyzer.add_rising_edge_trigger("hdmi_out0_core_timinggenerator_source_payload_hsync")
analyzer.add_trigger(cond={"hdmi_out0_core_timinggenerator_source_payload_de":0})
analyzer.add_trigger(cond={"hdmi_out0_core_timinggenerator_source_payload_vsync":0})
